...
const CONTRACTS: ContractSpec[] = [
  ...
  },
  {
    ...
    description: 'RelayTeleportAdapter — XCM InitiateTeleport adapter targeting the relay chain (DOT/PAS).',
  },
  {
    artifact: 'KaruraAdapter',
    output: 'karura-adapter',
    exportName: 'KARURA_ADAPTER_ABI',
    description: 'KaruraAdapter — Karura DEX (Dex.swapWithExactSupply) via XCM Transact (para 2000).',
  },
  {
    artifact: 'MoonbeamAdapter',
    output: 'moonbeam-adapter',
    exportName: 'MOONBEAM_ADAPTER_ABI',
    description: 'MoonbeamAdapter — EVM call via XCM Transact on Moonbeam (para 2004, Ethereum pallet 4).',
  },
  {
