...
// Source: obi.router/out/AssetHubPairAdapter.sol/AssetHubPairAdapter.json
// Router path: /home/harry-riddle/dev/github.com/obidot/obi.router
// Synced: 2026-03-28T07:01:46.120Z
//
// AssetHubPairAdapter — Asset Hub native pair adapter with optional oracle-backed simulation mode.

export const ASSET_HUB_PAIR_ADAPTER_ABI = [
  {
    type: 'constructor',
    inputs: [
      {
    ...
    outputs: [
      {
        name: '',
        type: 'address',
        internalType: 'contract IOracleRegistryStrictLike',
      },
    ],
    stateMutability: 'view',
  },
