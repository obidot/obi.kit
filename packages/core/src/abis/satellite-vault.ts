...
// Synced: 2026-03-28T07:01:46.117Z
//
...
export const SATELLITE_VAULT_ABI = [
  {
    ...
    inputs: [
      ...
      {
        name: '_hubRouterModule',
        type: 'bytes',
        internalType: 'bytes',
      },
      {
        name: '_chainIdentifier',
        type: 'bytes',
        internalType: 'bytes',
      },
      {
